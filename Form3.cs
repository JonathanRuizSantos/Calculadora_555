...
namespace CalculadoraR1R2C1_555C1C2C3
{
    public partial class Form3 : Form
    {
        ...
        private void btC1R2_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
        ...
        private void btC1R2NyR1_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
        ...
        private void btC1R1N_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
        ...
        private void btC2T1YT2_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
        ...
        private void btC2R2_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
        ...
        private void btC2R2NYR1_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
        ...
        private void btC2R1N_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
        ...
        private void btC3R2_Click_1(object sender, EventArgs e)
        {
            try
            {
                Entrada();
